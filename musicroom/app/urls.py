...
from . import views 
from Playlist.views import code_check, playlist_view,playlist_add,playlist_delete,api_add_song,api_delete_song,get_host_db
...
urlpatterns = [
    ...
    path('get_host_db/',get_host_db,name='get_host_db'),
